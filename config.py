...
ML_MODEL_PATH           = str(ML_DIR / "amt_model.json")
ML_ENCODERS_PATH        = str(ML_DIR / "amt_encoders.json")
...
ML_MLP_ENCODERS_PATH    = str(ML_DIR / "amt_mlp_encoders.json")
ML_MLP_SCALER_PATH      = str(ML_DIR / "amt_mlp_scaler.json")
